...
const AdressForm = () => {
  ...
  return (
    <div className="w-full flex flex-col gap-2 max-w-[450px]">
        <span className="w-full py-2  text-[14px] text-blue-400 bg-primary uppercase"><span className="w-4 h-4 rounded-full text-[14px] text-blue-400">3</span> Yeni Teslimat Addresi gir</span>
