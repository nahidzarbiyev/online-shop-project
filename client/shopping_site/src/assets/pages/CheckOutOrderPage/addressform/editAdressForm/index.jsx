...
const EditAdressForm = (props) => {
  ...
  return (
    ...
    <span className="w-full py-2 px-2  text-[14px] text-blue-400 bg-primary uppercase"><span className="w-4 h-4 rounded-full text-[14px] text-blue-400">3</span> Yeni Teslimat Addresi gir</span>

{
auth.authenticate ?
<form action="" className="flex flex-col gap-3" onSubmit={(e)=>AddressSubmit(e)}>
...
<button type="submit" className=" px-10 py-2  bg-dark rounded text-primary transition-colors duration-300 hover:text-dark hover:bg-primary hover:border-primary">Save</button>
</form>
:
null
}
