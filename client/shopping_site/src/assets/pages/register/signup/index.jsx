...
<form action="" className="flex flex-col gap-4 p-4 w-[300px] items-center justify-center" onSubmit={userLogin}>
    ...
    <span className='text-gray-500 text-xs text-center'>Nike Üye profilini oluşturarak Nike'ın en iyi ürünlerine ilk erişen sen ol, topluluğa eriş ve ilham al.</span>
     <input  placeholder='First Name' onChange={(e)=>setEmail(e.target.value)} className="border placeholder:text-sm  outline-none p-2 w-80 rounded"/>
     <input  placeholder='Last Name' onChange={(e)=>setEmail(e.target.value)} className="border placeholder:text-sm  outline-none p-2 w-80 rounded"/>
