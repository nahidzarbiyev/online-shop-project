...
<div className="w-56 h-[100vh] bg-dark flex flex-col justify-between fixed  py-10 px-2 gap-7 items-center">
      ...
      <div>
        <ul className="flex flex-col gap-7">
          <li>
            <NavLink
              to="/"
              className="flex gap-3 active:bg-white  items-center text-sm  bg-white text-dark px-10 py-2 "
            >
              {" "}
      ...
      <div className="flex flex-col gap-4 p-2">
        ...
        <span className="underline text-gray-400 text-xs">test@gmail.com</span>

        <span className="text-gray-500 text-xs">
          © 2023 Nike, Inc. All Rights Reserved
        </span>
        <button onClick={()=>logout()} className="uppercase px-10 flex items-center justify-center gap-2 py-2 bg-gray-800 text-white text-sm font-bold">
          Log Out <FiLogOut/>
        </button>
      </div>
</div>
